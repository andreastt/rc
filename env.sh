...
export trymn="-b do -p linux64,macosx64,win64,android-api-15 -u xpcshell,marionette,marionette-e10s,web-platform-tests,firefox-ui-functional,firefox-ui-functional-e10s,external-media-tests,reftest,mochitest -t none"
