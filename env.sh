...
export trymn="-b do -e -p linux64,macosx64,win64,android-api-15 -u xpcshell,marionette,marionette-e10s,luciddream,web-platform-tests,firefox-ui-functional,firefox-ui-functional-e10s -t none"
